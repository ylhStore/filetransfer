...
{
    REGISTER_PROCESSOR(PBMessage::kResponseGet, CResponseGet);
    REGISTER_PROCESSOR(PBMessage::kResponseList, CResponseList);
    REGISTER_PROCESSOR(PBMessage::kResponsePasv, CResponsePasv);
    REGISTER_PROCESSOR(PBMessage::kResponseDownload, CResponseDownload);
}
